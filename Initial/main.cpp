...
int main() {
    ...
    GLfloat x0 = 0.0f; // Center's x coordinate
    GLfloat y0 = 0.0f; // Center's y coordinate
    GLfloat r = 0.6f; // radius
    GLfloat circle[300];

    GLfloat t;
    GLint i;
    GLfloat step = (2*PI)/100.0f;
    ...
    window = glfwCreateWindow(1000, 1000, "Hello Triangle", NULL, NULL);
    if (!window) {
